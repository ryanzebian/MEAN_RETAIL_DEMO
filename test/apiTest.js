...
describe('Product API', function () {
    ...
    before(function () {
        ...
        //BootStrap server
        models = require('./../schemas/model')(wagner);
    ...
    it('can checkout', function (done) {
        ...
        User.findOne({}, function (error, user) {
            ...
            user.save(function (error) {
                ...
                superagent.post(url).
                    send({
                        //Fake stripe credentials. stripe token can either be 
                        //real credit card cred or  an encrypted token  -
                        ...
                        assert.equal(res.status, status.OK);
                        var result;
                        assert.doesNotThrow(function () { result = JSON.parse(res.text) });
